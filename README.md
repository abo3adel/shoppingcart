...
Highly inspired by [LaravelShoppingcart](https://github.com/Crinsane/LaravelShoppingcart#instances)
...
> collection of cart items for current instance.
> all collection methods allowed (https://laravel.com/docs/7.x/collections)[see-Collections]
